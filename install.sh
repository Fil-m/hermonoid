...
# ============================================================
echo -e "${YELLOW}[1/6] Оновлення пакетів Termux...${NC}"
...
# ============================================================
echo -e "${YELLOW}[2/6] Встановлення необхідних пакетів...${NC}"
pkg install -y python git curl termux-am ripgrep 2>&1 | tail -3

# ============================================================
# Крок 3: Доступ до файлової системи (Android Storage)
# ============================================================
echo -e "${YELLOW}[3/6] Налаштування доступу до файлової системи...${NC}"
...
# ============================================================
echo -e "${YELLOW}[4/6] Встановлення Hermonoid...${NC}"
...
# ============================================================
# Крок 5: Перевірка Hermes Agent
# ============================================================
echo -e "${YELLOW}[5/6] Перевірка Hermes Agent...${NC}"
...
# ============================================================
# Крок 6: Запуск сервера + копіювання посилання
# ============================================================
echo -e "${YELLOW}[6/6] Запуск Hermonoid сервера...${NC}"
